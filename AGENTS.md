...
- The current published version is 2.4.0 across `.claude-plugin/marketplace.json`, `.plugin/plugin.json`, and root `SKILL.md`. The standard package includes 24 skills: 15 core skills plus 9 Azure adaptation skills.
